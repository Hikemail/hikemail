  ...
  return (
    <div className="container">
      <div className="stepBox">
        ...
        <img src={HikeApply} alt="Hike Apply" className="hikeApply" style={{ height:  "55%", width: "60%", margin: "0 auto" }} />
        <p>Submit job applications via your hikemail.</p>
      </div>
      <div className="stepBox">
        <div className="words" style ={{marginTop: "15px"}}>TRACK</div>
        <img src={HikeStatus} alt="Hike Status" className="hikeStatus" style={{ height:  "55%", width: "60%", margin: "0 auto" }} />
      ...
      <div className="stepBox">
        ...
        <img src={HikeAccept} alt="Hike Accept" className="hikeAccept" style={{ height:  "55%", width: "60%", margin: "0 auto" }} />
